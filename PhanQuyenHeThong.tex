...
\toprule
\textbf{Cấp Quản Lý} & \textbf{Tài Khoản} & \textbf{Mật Khẩu} & \textbf{Phạm Vi} & \textbf{Chức Năng Cho Phép} \\
\midrule
\endfirsthead
\multicolumn{5}{c}%
...
\midrule
Admin Trạm & \texttt{admin} & \texttt{Admin@123} & Chỉ trong Trạm con được gán. & 
...
\begin{itemize}
    ...
    \item \textbf{Bảo vệ tài khoản mặc định}: Các tài khoản admin hệ thống mặc định (\texttt{multi}, \texttt{provinceadmin}, \texttt{admin}, \texttt{teamleader}) sẽ tự động bị ẩn các chức năng Sửa, Đổi mật khẩu, Vô hiệu hóa trên giao diện để tránh trường hợp quản trị viên vô tình tự khóa tài khoản của mình.
