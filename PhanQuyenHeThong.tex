...
\begin{titlepage}
    ...
    \textbf{Tác giả:} Đội ngũ Kỹ thuật StationOS\\
    \vfill
    {\large \today \par}
\end{titlepage}
...
\begin{figure}[htbp]
    ...
    \begin{tikzpicture}[node distance=1.8cm, scale=0.85, every node/.style={transform shape}]
        ...
        \node (T3_LA) [t3, below left=1cm and 1.5cm of T4] {\textbf{TẦNG 3: Admin Tỉnh (provinceadmin)} \\ $\bullet$ Quản lý Tỉnh Long An \\ $\bullet$ Quản lý các Tổ/Trạm thuộc Long An};
        
        \node (T3_TN) [t3, below right=1cm and 1.5cm of T4] {\textbf{TẦNG 3: Admin Tỉnh (provinceadmin)} \\ $\bullet$ Quản lý Tỉnh Tây Ninh \\ $\bullet$ Quản lý các Tổ/Trạm thuộc Tây Ninh};
