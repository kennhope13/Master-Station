...
//   VITE_API_URL    = http://localhost:6000   (backend REST + SignalR)
//   VITE_GO2RTC_URL = http://localhost:2984   (stream camera RTSP→WebRTC)
//   VITE_APP_MODE   = onprem | cloud
// ============================================================

// URL server go2rtc để phát stream camera qua WebRTC
const rawGo2rtc = (import.meta.env.VITE_GO2RTC_URL as string | undefined) ?? 'http://localhost:2984';
